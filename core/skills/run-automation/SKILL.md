---
name: run-automation
description: Run scheduled news reports, overnight media work, memory maintenance, retries, and health checks for 栗壳小院.
---
...
3. News patrols append a timestamped report and never overwrite an older report.
