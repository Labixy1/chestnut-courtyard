...
if (invalidTranslationCard.includes('查看中文翻译') || invalidTranslationCard.includes('<b>中文翻译</b>')) throw new Error('English text must never be labeled as a Chinese translation');
