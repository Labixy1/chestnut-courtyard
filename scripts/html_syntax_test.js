...
if (!home.includes('navigator.geolocation.getCurrentPosition') || !home.includes("'/api/weather'+positionQuery")) throw new Error('owner weather must prefer browser location when permission is available');
